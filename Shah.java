...
public class Shah {
    ...
    public static void mMoves(String[][] gameBoard, int indexOne, int indexTwo, Scanner swap, int round, String swapHelp,int blackRounds,int whiteRounds,int winCount) {
        ...
        if (indexOne < 10) {
            ...
            if ( gameBoard[indexOne][indexTwo].substring(0,1).equals(gameBoard[indexOne + 2][indexTwo].substring(0,1))||gameBoard[indexOne+2][indexTwo].equals("Fre")){
        ...
        if (indexTwo < 10) {
            ...
            if ( gameBoard[indexOne][indexTwo].substring(0,1).equals(gameBoard[indexOne][indexTwo+2].substring(0,1))||gameBoard[indexOne][indexTwo+2].equals("Fre")){
